<?php
	// Your Email
	$recipient = "info@enfantpoulet.com "; // PLEASE SET THE EMAIL ADDRESS of recipient
	$recipient_name = "Enfant Poulet / Contacto"; // PLEASE SET THE NAME OF the email address holder
	$subject_title = "Mensaje nuevo de tu sitio web"; //
	...
	// Build Message
	$email_content = "Nombre: $fname\n";
	$email_content .= "Apellidos: $lname\n";
	if(array_key_exists('website', $_POST)) {
